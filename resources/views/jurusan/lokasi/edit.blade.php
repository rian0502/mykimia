                    ...
                    <div class="profile-edit-list row">
                        ...
                        <div class="weight-500 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus name="nama_gedung" id="nama_gedung" value="{{ $lokasi->nama_gedung }}"
                                    class="form-control @error('nama_gedung') form-control-danger @enderror" type="text"
                        ...
                        <div class="merek weight-500 col-md-6">
                            <div class="form-group">
                                ...
                                <input autofocus name="lantai_tingkat" id="lantai_tingkat" value="{{ $lokasi->lantai_tingkat }}"
                                    class="form-control @error('lantai_tingkat') form-control-danger @enderror" min="0"
